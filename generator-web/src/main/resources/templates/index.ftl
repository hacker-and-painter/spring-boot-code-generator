        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="btn-toolbar col-md-7" role="toolbar" aria-label="Toolbar with button groups">
                ...
                <div class="btn-group" role="group" aria-label="First group">
                    ...
                    <button type="button" class="btn btn-default generator" id="jpa-rest-add-param">addParam</button>
                    <button type="button" class="btn btn-default generator" id="jpa-rest-update-param">updateParam</button>
                    <button type="button" class="btn btn-default generator" id="jpa-rest-page-param">pageParam</button>
                    <button type="button" class="btn btn-default generator" id="projection">projection</button>
        ...
        <footer class="bd-footer text-muted" role="contentinfo">
            <div class="container">
               <strong>Copyright &copy; ${.now?string('yyyy')}-2022 &nbsp;
                   <p>项目地址: <a href="https://github.com/moshowgame/SpringBootCodeGenerator">SpringBootCodeGenerator</a>  原始项目地址: <a href="https://github.com/moshowgame/SpringBootCodeGenerator">SpringBootCodeGenerator</a>由<a href="https://blog.csdn.net/moshowgame" target="_blank">@Moshow/大狼狗/郑锴</a> 开发维护。
            </div>
        </footer>
    </footer>
</div> <!-- /container -->
